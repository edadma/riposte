...
| `riposte-salle`   | Styled, skinnable component library — form controls (incl. Segmented), Image/Lightbox, Badge/Tag, Skeleton, Spinner/Progress, Pagination, Dropdown, Tabs, Modal/Drawer/Toast/Tooltip, Layout/Navbar/Footer shell, grid + masonry layout, theming |
