...
```scala
libraryDependencies += "io.github.edadma" %%% "riposte"        % "0.3.4"
libraryDependencies += "io.github.edadma" %%% "riposte-atoms"  % "0.3.4"
libraryDependencies += "io.github.edadma" %%% "riposte-router" % "0.3.4"
libraryDependencies += "io.github.edadma" %%% "riposte-query"  % "0.3.4"
libraryDependencies += "io.github.edadma" %%% "riposte-forms"  % "0.3.4"
libraryDependencies += "io.github.edadma" %%% "riposte-salle"  % "0.3.4"
```
