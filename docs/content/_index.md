...
the model — components, hooks, shared state, routing, data fetching, and forms — then look up
the exact API surface when you need it.

- **[Getting Started](/getting-started/)** — install Riposte and mount your first component.
- **[Guide](/guide/)** — the DSL, hooks, shared state with atoms, the router, queries, and forms.
